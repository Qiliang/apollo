Ext.define('Kits.view.liShiShuju.E41002_Y0101+限上法人消费品零售额增速（可比口径）_429021000000_20160008_20170523', {
    extend: 'Kits.view.liShiShuju.Base',
    title: 'E41002_Y0101+限上法人消费品零售额增速（可比口径）_429021000000_20160008_20170523',
    headerItems: [
        {
            html: ''
        },
        {
            html: 'E41002_Y0101+限上法人消费品零售额增速（可比口径）_429021000000_20160008_20170523',
        },
        {
            html: ''
        }
    ...
    store: Ext.create('Ext.data.ArrayStore', {
        ...
        'col6'],
        data: [
        ['社会消费品零售总额','1592.1','9640.1','1593.7','9654.8','-0.1','-0.2'],
        ['  城镇','1592.1','9640.1','1593.7','9654.8','-0.1','-0.2'],
        ['    餐饮收入','267.1','1043.8','302.4','1053.5','-11.7','-0.9'],
        ['    商品零售','1325.0','8596.3','1291.3','8601.3','2.6','-0.1']],
    }),
    columns: [ {

Ext.define('Kits.view.liShiShuju.E41002_Y0101+限上法人消费品零售额增速（可比口径）_429021000000_20160012_20170523', {
    extend: 'Kits.view.liShiShuju.Base',
    title: 'E41002_Y0101+限上法人消费品零售额增速（可比口径）_429021000000_20160012_20170523',
    headerItems: [
        {
            html: ''
        },
        {
            html: 'E41002_Y0101+限上法人消费品零售额增速（可比口径）_429021000000_20160012_20170523',
        },
        {
            html: ''
        }
    ...
    store: Ext.create('Ext.data.ArrayStore', {
        ...
        'col6'],
        data: [
        ['社会消费品零售总额','1656.5','16957.2','994.6','14601.1','66.5','16.1'],
        ['  城镇','1656.5','16957.2','994.6','14601.1','66.5','16.1'],
        ['    餐饮收入','98.6','2029.0','84.1','1827.5','17.2','11.0'],
        ['    商品零售','1557.9','14928.2','910.5','12773.6','71.1','16.9']],
    }),
    columns: [ {

Ext.define('Kits.view.tables.Base', {
    ...
    initComponent: function () {
        ...
        Ext.apply(me.items[0].items, this.headerItems);
        Ext.apply(me.items[1].store, this.store);
        Ext.apply(me.items[1].columns, this.columns);
        Ext.apply(me.items[2].items, this.footerItems);
